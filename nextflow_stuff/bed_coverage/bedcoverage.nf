...
params.run = "20230918_MiSeq-Appa"
params.plate = "Staphylococcus_epidermidis"


bam_ch = Channel
        .fromPath("s3://seqwell-analysis/" + params.run + "/{" + params.plate + "}/bam/" + "*.md.bam")
        .map{ it -> tuple(  it.baseName.tokenize("_")[1..2].join("_"),  it.baseName.tokenize(".")[0], it)}
